...
| :-- | :-- | :-- |
| **[pi-atelier](https://github.com/michaelmjhhhh/pi-atelier)** <br>`★ 258` | An elegant status rail, menu, and sidebar for the Pi coding agent, published on npm with no telemetry and no network calls. | `TypeScript` |
